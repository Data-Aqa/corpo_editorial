...
Este repositório foi criado para disponibilizar os códigos do corpo editorial que são realizados na Data.Aqa no Medium. 
...
nbviewer é um site que permite visualizar arquivos .ipynb (arquivos das aulas) com formatação feita em HTML. Basta acessar **[aqui](https://nbviewer.org/github/Data-Aqa/corpo_editorial/tree/main/)** e se direcionar à pasta do tema que deseja visualizar, clicar na aula e pronto. 
